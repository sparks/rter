...
public class ScrollingPlot {
	...
	private final int barCount = 10;
	private final float graphSize = 100;
	...
	private int time, oldTime;
	private float[] values;
	
	public ScrollingPlot(DataVis parent, PVector position, String title, float min, float max, int low, int high) {
		this.parent = parent;
