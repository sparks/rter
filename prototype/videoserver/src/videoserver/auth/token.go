...
func (t *Token) VerifyLifetime() error {
...
func NewTokenFromHttpRequest(r *http.Request) (*Token, error) {
...
func GenerateToken(uri, consumer string, valid time.Duration, key string) (*Token, error) {
