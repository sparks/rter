...
CREATE TABLE IF NOT EXISTS user_directions (
	...
	lock_user_id INT NOT NULL DEFAULT -1,
...
CREATE TABLE IF NOT EXISTS items (
	...
	thumbnail_URI VARCHAR(2048) NOT NULL DEFAULT "",
	content_URI VARCHAR(2048) NOT NULL DEFAULT "",
	upload_URI VARCHAR(2048) NOT NULL DEFAULT "",
	PRIMARY KEY(id),
